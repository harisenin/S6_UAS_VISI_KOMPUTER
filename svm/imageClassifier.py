...
DIMENSION = 32
ROOT_DIR = r'/Users/triseptianto/Downloads/svm/gambar/'
AYAM = "ayam"
KAMBING= "kambing"
SAPI="sapi"
...
def main():
    try:
        ...
        for clazz in CLASSES:
            ...
            print (clazz, correct, count, (float(correct) / count))
        print ("Overall", totalCorrect, totalCount, (float(totalCorrect) / totalCount))
...
def classify(models, dataSet):
    ...
    for trueClazz in CLASSES:
        ...
        for item in dataSet[trueClazz]:
            ...
            print (trueClazz, predClazz, prob)
            count += 1
